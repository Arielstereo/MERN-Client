  ...
  return (
    <>
      <form
        ...
        className="bg-gradient-to-r from-slate-800 to-slate-600 p-10 rounded-lg shadow-2xl w-1/3"
      >
        <h1 className="text-center text-2xl mb-6 text-slate-100 font-bold font-sans">
          Register
        </h1>
        <div>
